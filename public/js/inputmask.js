                        ...
                        if (i.index >= a) {
                          ...
                          if (void 0 !== e) {
                            if (r) {
                              ...
                              (P(t).lastIndex = c),
                                (s = e.slice(0, e.indexOf(u.nextMatch[0])));
                            } else {
                              for (
                                var f = i[0][0], p = i.index;
                                n &&
                                (t.placeholder[
                                  l.getTest.call(n, p).match.placeholder
                                ] || l.getTest.call(n, p).match.placeholder) ===
                                  f;
                              ...
                              s = e.slice(
                                0,
                                d || (y[o] && y[o][4]) || o.length
                              );
                            }
                            e = e.slice(s.length);
                          }
                          Object.prototype.hasOwnProperty.call(y, o) &&
                            this.setValue(this, s, o, y[o][2], y[o][1]);
                        }
                    },
                  },
                  {
